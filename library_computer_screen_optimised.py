...
sorting_buttons=Frame(mainframe,bg="#C0FF2E",border=5,relief="raised") # this frame is for all the buttons regarding te showing of the books
sorting_buttons.pack(side="right",fill="both") # packing the sorting_buttons frame
...
Button(titlebar,text="Exit",bg=textcolor,fg="white",font="Times 15 bold italic",border=5,relief="sunken",command="exit").pack(side="right") # single liner packing of the exit button
...
Button(search_books,text="Submit",bg=textcolor,fg="white",font="Times 15 bold italic",border=10,relief="sunken",command=submit).pack(padx=10,pady=10) # single liner packing of the exit button

timeupdate()

# content of the sorting_buttons frame
Label(sorting_buttons, text = "Show",bg="#C0FF2E",fg="black",font="Times 25 bold italic underline").grid(row=0,column=0,pady=20)
# .pack(padx=20,pady=20,anchor="nw")

b1=Button(sorting_buttons,text="  Show all the books  ",bg="#26B0FF",fg="white",borderwidth=10,font="Times 15 bold italic",command=showall)
b1.grid(row=1,column=0,pady=10)
#b1.pack(pady=10,anchor="w")
# b1.bind("<Button->")

b2=Button(sorting_buttons,text="    Available books     ",bg="#A1CDFF",fg="black",borderwidth=10,font="Times 15 bold italic" )
b2.grid(row=2,column=0,pady=10,padx=30)
# b2.pack(pady=10,anchor="w")
b2.bind("<Button->",availability)

b3=Button(sorting_buttons,text="     Return a book     ",bg="#26B0FF",fg="white",borderwidth=10,font="Times 15 bold italic" )
b3.grid(row=3,column=0,pady=10)
#b3.pack(pady=10,anchor="w")
b3.bind("<Button->",click)

b4=Button(sorting_buttons,text="       Buy stocks        ",bg="#A1CDFF",fg="black",borderwidth=10,font="Times 15 bold italic" )
b4.grid(row=4,column=0,pady=10)
#b4.pack(pady=10,anchor="w")
b4.bind("<Button->",click)

b5=Button(sorting_buttons,text="        Book Lost        ",bg="#26B0FF",fg="white",borderwidth=10,font="Times 15 bold italic" )
...
status_back=Button(info_books_statusbar,text="  <<  ",bg="red",fg="white",font="Times 10 bold",border=10,relief="raised")
status_back.pack(side="left",padx=20)

status_forward=Button(info_books_statusbar,text="  >>  ",bg="red",fg="white",font="Times 10 bold",border=10,relief="raised",command=book_details)
