...
b1=Button(sorting_buttons,text="  Show all the books  ",bg="yellow",fg="blue",borderwidth=10,font="Times 15 bold italic",command=showall)
b1.grid(row=1,column=0,pady=10)
#b1.pack(pady=10,anchor="w")
# b1.bind("<Button->")

b2=Button(sorting_buttons,text="    Available books     ",bg="yellow",fg="blue",borderwidth=10,font="Times 15 bold italic" )
b2.grid(row=2,column=0,pady=10,padx=30)
# b2.pack(pady=10,anchor="w")
b2.bind("<Button->",availability)

b3=Button(sorting_buttons,text="     Return a book     ",bg="yellow",fg="blue",borderwidth=10,font="Times 15 bold italic" )
b3.grid(row=3,column=0,pady=10)
#b3.pack(pady=10,anchor="w")
b3.bind("<Button->",click)

b4=Button(sorting_buttons,text="       Buy stocks        ",bg="yellow",fg="blue",borderwidth=10,font="Times 15 bold italic" )
b4.grid(row=4,column=0,pady=10)
#b4.pack(pady=10,anchor="w")
b4.bind("<Button->",click)

b5=Button(sorting_buttons,text="        Book Lost        ",bg="yellow",fg="blue",borderwidth=10,font="Times 15 bold italic" )
