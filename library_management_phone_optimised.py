...
main_label = Label(root,text="Backbone logic written\nBy Rohan Dey",font="Times 10 bold italic",bg="#C0FF2E")
# main_lablel.grid(row=0,column=0,columnspan=5)
main_label.pack(pady=10,anchor="se")


main_label = Label(root,text="GUI designed by \nPartha Sarathi Dey",font="Times 10 bold italic",bg="#C0FF2E")

# main_lablel.grid(row=0,column=0,columnspan=5)
main_label.pack(pady=10,anchor="sw")
